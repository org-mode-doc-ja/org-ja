...
%
\def\texinfoversion{2011-12-10.12}
%
...
\def\xrefX[#1,#2,#3,#4,#5,#6]{\begingroup
  ...
  \iffloat\Xthisreftitle
    ...
    \ifdim \wd1 > 0pt
      ...
      \xrefprintinmanual{\printedmanual}
    \fi
  \else
    ...
    \ifdim \wd1 > 0pt
      ...
      \xrefprintrefinmanual{\printedrefname}{\printedmanual}
    \else
      \xrefprintnodename%
...
% @takaxp - replace
% for localization hook point
\def\xrefprintinmanual#1#2{\space \putwordin{} \cite{#1}}
\def\xrefprintrefinmanual#1#2{\putwordSection{} ``#1'' \putwordin{} \cite{#2}}
